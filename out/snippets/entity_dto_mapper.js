...
exports.generateDtoFile = generateDtoFile;
exports.generateMapperFile = generateMapperFile;
function generateEntityFile(className) {
    return `// Entity CLASS
...
function generateDtoFile(className) {
    return `// DTO CLASS
// ****************************************
//  ${className} DTO
// ****************************************
...
function generateMapperFile(className) {
...
//# sourceMappingURL=entity_dto_mapper.js.map